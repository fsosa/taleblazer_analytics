		...
		// Configuration options
		{
			setterMethods: {
				draft_id: function(draft_id) {
					this.setDataValue('draft_id', draft_id);
				},
				game_event_id: function(game_event_id) {
					this.setDataValue('game_event_id', game_event_id);
				},
				transaction: function(transaction) {
					this.setDataValue('transaction', transaction);
				}
			},
			getterMethods: {
				draft_id: function() {
					return this.getDataValue('draft_id');
				},
				game_event_id: function() {
					return this.getDataValue('game_event_id');
				},
				transaction: function() {
					return this.getDataValue('transaction');
				}
			},
			classMethods: {
...
var createParentCustomEvent = function(models, custom_event_trigger, callback) {
	models.CustomEvent
		...
		}, custom_event_trigger.transaction)
